...
void gen_File(vector<string> init_dict) {
    ofstream file;
    file.open("/Users/kseniasklarova/Documents/discr_0.1/discr_0.1/File.txt");
    if (file.is_open())
    {
        srand(time(NULL));
        string str;
...
void LZW_coder(vector<string> init_dict, string w) {
    ...
    fin.open(w);
    fout.open("/Users/kseniasklarova/Documents/discr_0.1/discr_0.1/encode_File.txt");
...
void LZW_decoder(vector<string> init_dict, string w) {
    ...
    fin.open(w);
    fout.open("/Users/kseniasklarova/Documents/discr_0.1/discr_0.1/decode_File.txt");
...
void RLE_coder(string w){
    ...
    fin.open(w);
    fout.open("/Users/kseniasklarova/Documents/discr_0.1/discr_0.1/rle_coder.txt");
...
void RLE_decoder(string w){
    ...
    fin.open(w);
    fout.open("/Users/kseniasklarova/Documents/discr_0.1/discr_0.1/RLE_decoder.txt");
...
void RLE_LZW_coder(){
    RLE_coder("/Users/kseniasklarova/Documents/discr_0.1/discr_0.1/File.txt");
    LZW_coder(alph, "/Users/kseniasklarova/Documents/discr_0.1/discr_0.1/rle_coder.txt");
}
void RLE_LZW_decoder(){
    LZW_decoder(alph, "/Users/kseniasklarova/Documents/discr_0.1/discr_0.1/encode_File.txt");
    RLE_decoder("/Users/kseniasklarova/Documents/discr_0.1/discr_0.1/decode_File.txt");
}



void LZW_RLE_coder(){
    LZW_coder(alph, "/Users/kseniasklarova/Documents/discr_0.1/discr_0.1/File.txt");
    RLE_coder("/Users/kseniasklarova/Documents/discr_0.1/discr_0.1/encode_File.txt");
}
void LZW_RLE_decoder(){
    RLE_decoder("/Users/kseniasklarova/Documents/discr_0.1/discr_0.1/rle_coder.txt");
    LZW_decoder(alph, "/Users/kseniasklarova/Documents/discr_0.1/discr_0.1/RLE_decoder.txt");
}
...
int main(int argc, const char * argv[]) {
    ...
    string File("/Users/kseniasklarova/Documents/discr_0.1/discr_0.1/File.txt");
    string encode_File("/Users/kseniasklarova/Documents/discr_0.1/discr_0.1/encode_File.txt");
    string decode_File("/Users/kseniasklarova/Documents/discr_0.1/discr_0.1/decode_File.txt");
    string rle_coder("/Users/kseniasklarova/Documents/discr_0.1/discr_0.1/rle_coder.txt");
    string _RLE_decoder("/Users/kseniasklarova/Documents/discr_0.1/discr_0.1/RLE_decoder.txt");
    ...
    cout << "parallel" << endl;
    vector<int> my_cnt;
    LZW_coder_parallel(alph, 7, File, encode_File, my_cnt);
    ...
    //my_cnt.clear();
    cout << "parallel" << endl;
    RLE_coder_parallel(File, 3, rle_coder, my_cnt);
    ...
    cout << "parallel RLE LZW" << endl;
    
    RLE_coder_parallel(File, 7, rle_coder, my_cnt);
    vector<int> my_cnt1;
    LZW_coder_parallel(alph, 7, rle_coder, encode_File, my_cnt1);
    ...
    cout << "parallel LZW RLE" << endl;
    
    LZW_coder_parallel(alph, 7, File, encode_File, my_cnt);
    RLE_coder_parallel(encode_File, 7, rle_coder, my_cnt1);
